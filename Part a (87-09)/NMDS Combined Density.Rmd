...
density_wo_su_rel <- decostand(density_wo_su,method="total") #calculate relative abundance from abundance data
```
...
set.seed(1)
nmds_density <- metaMDS(density_wo_su_rel,distance="bray",maxit=999,trymax = 500,wascores = T,k=2)
```
