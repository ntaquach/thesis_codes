---
title: "NMDS (Count) - SPATIALLY EXAMINED"
author: "Frank"
...
These are codes I used to run NMDS on Count data collected by the BC DEPS at all benthic sites after 2009. Please note that 
...
count_allsite_part2_graph <- ggplot(data.scores.dplyr, aes(x = NMDS1, y = NMDS2)) + 
    ...
    scale_shape_manual(values = c(0,1,2,5,6,11,21,22,23,24,25)) +
    ...
    labs(
    title = "NMDS graph of Part B Count for all sites") + 
