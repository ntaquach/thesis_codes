---
title: "Villa Nova Discharge Code"
author: "Frank"
...
These are the codes I used to run to extract and analyze discharge (Q) data collected from the [Gwynns Falls - Villa Nova USGS gauging station.](https://waterdata.usgs.gov/md/nwis/uv/?site_no=01589300 "Villa Nova") All credit goes to the [EGRET package](https://usgs-r.github.io/EGRET/articles/streamflow_trend.html "EGRET") developed by USGS and also to [Dr. Joel Moore](https://wp.towson.edu/moore/ "Dr. Joel Moore"), my thesis committee member, who modified the sample codes and provided me the codes. 
...
It is also helpful to investigate whether low and high flows are decreasing or increasing. Low flow is defined by the lowest 7Q value annually [(Evett et al., 1994).](http://www.lib.ncsu.edu/resolver/1840.4/1965 "Evett et al. 1994") 7Q value is the minimum average daily Q for any seven consecutive days.
