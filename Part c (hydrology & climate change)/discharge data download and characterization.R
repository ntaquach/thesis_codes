#### ### ### ### ### ### ### ### ### ### ### ### ### ### ###
# Read in daily discharge (Q) data for Gwynns Falls - Villa Nova & 
#    perform statistical calculations
#
# Name: Joel Moore for Nguyen Tien Anh Quach
# Date: Mar 24 2022
# 
#
#           
...
# Detach/unload all libraries
lapply(paste('package:',names(sessionInfo()$otherPkgs),sep=""),detach,character.only=TRUE,unload=TRUE)


### 1. Load libraries, set working directory, & load data ####
...
### 2. Read in daily data ####
# Info from page below
# http://usgs-r.github.io/EGRET/articles/EGRET.html

# Set gaging site number
siteNumber <- '01589300' # Gwynns Falls at Villa Nova MD
# https://waterdata.usgs.gov/nwis/uv?site_no=01589300

# Set start & end dates for period
startDate <- '1957-02-28'
endDate <- '2021-09-30' # through end of 2021 water year
...
### 3. Various plots for discharge ####
# Taken from URL at start of section 2
...
### 4. More detailed characterization plots/stats from following page ####
# http://usgs-r.github.io/EGRET/articles/streamflow_trend.html
# Need to load functions in section section #99 to end of script before can perform these characterizations
...
dev.off() # for some reason, other plots choke after this

# Flow trend for start of year in April
# See more 
plotFlowTrend(eList, qUnit = 'cfs', paStart = 4, istat = 5) # see stat #s below; mean daily Q
plotFlowTrend(eList, qUnit = 'cfs', paStart = 4, istat = 8) # see stat #s below; 1 day max Q
plotFlowTrend(eList, qUnit = 'cfs', paStart = 4, istat = 4) # see stat #s below; median daily Q
plotFlowTrend(eList, qUnit = 'cfs', paStart = 4, istat = 7) # see stat #s below; 7 day max Q
...
# I can talk you through this plot if you want. The web page at the beginning of the section is helpful here too. 
